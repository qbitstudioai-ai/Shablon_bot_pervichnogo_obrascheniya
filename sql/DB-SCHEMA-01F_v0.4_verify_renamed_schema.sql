-- DB-SCHEMA-01F v0.4 FRESH-PATH: finalize/verify already-renamed qBit project schema
...
--   fresh-path copy: use this filename to avoid stale Supabase/GitHub editor content from v0.2/v0.3
--
-- PURPOSE
