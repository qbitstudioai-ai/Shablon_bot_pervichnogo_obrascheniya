...
Подготовлена документационная основа v0.3. Реализация и испытания системы ещё не выполнены. Текущий режим — **только документация**. Создание SQL, workflow, кода и запуск production начинаются в отдельных сессиях проекта после команды Павла.
