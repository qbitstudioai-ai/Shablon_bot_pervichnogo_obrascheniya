...
До завершения PRE-01 workflow не проектируется. Перед началом проектирования n8n необходимо отдельно запросить у Павла обещанный эталонный образец и изучить его.
