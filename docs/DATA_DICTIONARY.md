...
Сроки очистки и хранения остаются PRE-03; представления отчётов — задачами UI. Связи и форматы операций: [INTEGRATION_CONTRACTS.md](specs/INTEGRATION_CONTRACTS.md). Доступ: [ACCESS_AND_ISOLATION.md](specs/ACCESS_AND_ISOLATION.md). DB-01 и DB-02 уже применены в test-контуре: созданы test schema/роли и 13 таблиц пользовательского/диалогового слоя. DB-03 разбит на DB-03A…DB-03D; DB-03A и DB-03B успешно применены и проверены в test-контуре. Родительский DB-03C дополнительно разделён на DB-03C1…C4. DB-03C1 v0.3 успешно применён и проверен. DB-03C2 v0.1 успешно применён и проверен. DB-03C3 v0.1 успешно применён и проверен. DB-03C4 v0.2 успешно применён и проверен; весь DB-03C завершён. DB-03D разделён на D1/D2; обе части успешно применены и проверены. Родительские DB-03C и DB-03D закрыты. Родительский DB-03 остаётся открыт только до DB-03V. Подготовлен `sql/DB-03V_late_confirm_after_take.sql` v0.1: disposable crossing probe `bot v_rabote → Take → late confirmed`, проверяющий сохранение external fact при подавлении stale stage/goal/wait/t0/reminders; server-check ещё не выполнен.
