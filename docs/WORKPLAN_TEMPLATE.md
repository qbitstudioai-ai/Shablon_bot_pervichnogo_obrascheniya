...
| [x] WF-01 | WF-00 | Подготовлены новые неактивные draft: клиентский v0.2 с темой с первого сообщения, зеркалом, фото/видео без AI и локальным STT; служебный операторский v0.1 с «Забрать/Вернуть» и ручным ответом. JSON структурно проверены; runtime зависит от DB и локального STT |
