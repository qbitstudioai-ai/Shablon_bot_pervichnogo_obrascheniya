...
| [ ] DB-03C1 | DB-03B | Реализованы `zaregistrirovat_vhod_klienta`, `sohranit_vlozhenie`, `sohranit_transkripciyu_golosa`, `sohranit_obezlichivanie`; same-key/same-hash возвращает прежний результат, same-key/different-hash даёт konflikt; первый вход создаёт job/topic mirror intent, новый вход отменяет старое ожидание |
