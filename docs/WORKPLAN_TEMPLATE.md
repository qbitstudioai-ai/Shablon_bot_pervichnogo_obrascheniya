...
| [~] DB-SCHEMA-01F | DB-SCHEMA-01 | `sql/DB-SCHEMA-01F_verify_renamed_schema.sql` v0.1: read-only verify новой schema, 25 tables/28 SECURITY DEFINER functions, owner/search_path/no old refs, EXECUTE 17/10/1, runtime DML denied, temporary DB CREATE revoked, production/canary present; после успеха Supabase-stage завершён и следующая сессия PRE-02/n8n |
