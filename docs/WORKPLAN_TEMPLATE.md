...
| [ ] DB-03 | DB-02 | Созданы очередь, короткая память 3–5 сообщений, долговечные важные факты, исходящие действия, тематические предупреждения/блокировка и напоминания; версии/блокировки/повторы проверены |
...
| Статус / ID | Зависимости | Один результат и критерий |
|---|---|---|
| [x] WF-00 | PRE-01 | Спроектирован неактивный draft клиентского workflow: русские ноды и sticky-блоки, надёжный вход, очередь, guard/3 предупреждения, PII, память, RAG, продажи, handoff, безопасная отправка и напоминания; JSON выдан в чате, runtime/DB ещё не проверены |
...
| [ ] BOT-02 | BOT-01 | Проверены этапы, цели, настраиваемый сбор полей, локальная заявка, завершение, просьба о человеке и ручной перехват менеджером; после передачи бот и напоминания не продолжают диалог без явного возврата управления |
